...
namespace TestCore
{
    public class TestHelpers
    {
        ...
        [Test]
        public void TestBestSellingProductsReturnsTrue()
        {
            var groceryListItems = new List<GroceryListItem>
            {
                new GroceryListItem(1, 1, 101, 2),
                new GroceryListItem(2, 1, 102, 3),
                new GroceryListItem(3, 2, 103, 1),
                new GroceryListItem(4, 2, 104, 5),
                new GroceryListItem(5, 3, 105, 4)
            };

            var products = new List<Product>
            {
                new Product(101, "Apple", 10),
                new Product(102, "Banana", 20),
                new Product(103, "Carrot", 30),
                new Product(104, "Date", 40),
                new Product(105, "Eggplant", 50)
            };
            ...
            {
                productRepoMock.Setup(r => r.Get(product.Id)).Returns(product);
            }

            IGroceryListItemsService groceryListItemsService = new GroceryListItemsService(
                groceryListItemsRepoMock.Object,
                productRepoMock.Object
            );

            List<BestSellingProducts> bestSellingProducts = groceryListItemsService.GetBestSellingProducts(5);

            Assert.IsTrue(bestSellingProducts.Count == 5);
        }

        [Test]
        public void TestBestSellingProductsReturnsFalse()
        {
            var groceryListItems = new List<GroceryListItem>
            {
                new GroceryListItem(1, 1, 101, 2),
            ...
            Assert.IsFalse(bestSellingProducts.Count == 5);
        }
